...
<body class="gray-bg">
    <div class="wrapper wrapper-content ">
            ...
            <table class="table table-bordered table-striped xedittable " id="content">
		            <tr>
		                 <td><strong>姓名</strong></td><td><a href="#" id="aac003" data-type="text" data-title="姓名"></a>  </td>
		                 <td><strong>身份证号码</strong></td><td><a href="#" id="aac002" data-type="text" data-title="身份证号码">${ac01.aac002}</a></td>
		            </tr>
		            <tr>
		                 ...
		                 <td><strong>民族</strong></td><td id="aac005">${ac01.aac005}</td>
		            </tr>
		            <tr>
		                 <td><strong>学历</strong></td><td id="aac011">${ac01.aac011}</td>
    ...
    $(function() {
    	var url=gateway_base_url+"/api-demo/demo/ac01/name";
    	rc.api_post_query(url,{id:$('#id').val()},$('#content'));
    })
     //关闭
