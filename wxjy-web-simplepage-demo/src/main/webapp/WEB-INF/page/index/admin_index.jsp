                ...
                <script id="tpl_menus" type="text/x-handlebars-template" > 
                    ...
                    <li class="fa-hover">
                        ...
                        <ul class="nav nav-second-level collapse">
						       ...
						       <li>
                                      {{#if child}}
		                                           <a   {{#equals isblanktarget 0 }}   class="J_menuItem"  href="{{url}}"   {{/equals}}  {{#equals isblanktarget 1 }}   target='_blank' {{/equals}} >
	                                               <i class="fa fa-detail {{iconcss}}"></i>{{permname}}<span class="fa arrow"></span>
		                                             ...
		                                             <ul class="nav nav-third-level collapse">
			                                           ...
			                                           <li>
			                                 	              {{#if child}}
			                                 	  	 	          <a {{#equals isblanktarget 0 }}   class="J_menuItem"  {{/equals}} href="{{url}}"  {{#equals isblanktarget 1 }}  target='_blank' {{/equals}}>
				                                                  <i class="fa fa-detail {{iconcss}}"></i>{{permname}}<span class="fa arrow"></span>
				                                                  </a>
			                                 	  	        ...
			                                 	  	        {{else}}
			                                 	  	        	<a 
			                                 	  		        {{#equals isblanktarget 0 }}  class="J_menuItem" {{/equals}}  href="{{url}}" {{#equals isblanktarget 1 }}  target='_blank' {{/equals}}>
