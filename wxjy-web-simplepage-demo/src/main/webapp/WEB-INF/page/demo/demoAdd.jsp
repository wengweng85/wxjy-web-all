...
<body class="gray-bg"  style="margin-top:40px" >
    ...
    <div class="wrapper wrapper-content ">
          <form action="<%=gateway_base_url%>/api-demo/demo/ac01/put" >
        <div >
	        <!-- 人员选择基本信息开始 -->
	        <div class="ibox ">
	            ...
	            <div class="ibox-content">
		            <div class="form-horizontal"  >
		              ...
		              -->     
			               <rc:textEditSuggest label="个人信息搜索" property="aac001" keytype="AC01" callback="select_demo_by_id"></rc:textEditSuggest>
			           </div>
	        ...
	        <div class="ibox ">
	            <div class="ibox-title">
	                <h5>附加信息 <i class="fa fa-chevron-up"></i> </h5>
	            </div>
	            <div class="ibox-content">
		            <div class="form-horizontal">
				        <div class="form-group">
			               <rc:select property="aab800" required="true"  label="户籍所在省"   filter="aaa102='610000'"  onchange="rc_tag.code_value_select_data_change(this.value,'AAB801',['#aab801','#aab802'])"    codetype="AAB800"  validate="{required:true,messages:{required:'户籍所在省不能为空'}}"/>
			               <rc:select property="aab801" required="true"  readonly="true"   filter=" 1=2 " label="户籍所在市"  onchange="rc_tag.code_value_select_data_change(this.value,'AAB802',['#aab802'])"     codetype="AAB801" validate="{required:true,messages:{required:'户籍所在市不能为空'}}"/>
			            ...
			            <div class="hr-line-dashed"></div>
					    <div class="form-group">
					       <rc:textEditIconCodeValue property="aab301"   codetype="AAB301" label="地区选择"   />
					    </div>
					    <div class="hr-line-dashed"></div>
					    <div class="form-group">
