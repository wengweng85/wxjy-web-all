...
<body class="gray-bg">
            ...
            <div class="ibox-content">
	            <form class="form-horizontal" id="query_form" >
			        <div class="form-group">
			            ...
			            <rc:select property="aac004" label="性别"     dynamic="true"  codetype="AAC004" multiple="true" />
			       </div>
        ...
        <div class="ibox float-e-margins">
			...
			<div id="myTabContent" class="tab-content">
			    <div class="tab-pane fade in active" id="home">
			        <table id="ac01table" data-url="<%=gateway_base_url %>/api-demo/demo/ac01s" 
    ...
    $(function(){
    	...
    	//$('.collapse-link').click();
    	$('#ac01table').inittable_v2(demo_options);
