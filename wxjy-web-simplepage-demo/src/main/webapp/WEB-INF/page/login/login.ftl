...
<style type="text/css">
body{
    background:url(webjars/img/loginDialog/background.jpg) no-repeat 0 0 scroll;
}
#text-title{
...
/*核心中间部分内容*/
#center_right{
 float:right;width:390px; height:400px; background:url(webjars/img/loginDialog/text_backbg.png) no-repeat;
...
<body>
	...
	<script src="${homeModule}/webjars/js/jQuery/all/jquery.js"></script>
    <script src="${homeModule}/webjars/js/bootstrap.min.js"></script>
    <script src="${homeModule}/webjars/js/plugins/layer/layer.min.js"></script>
    <script src="${homeModule}/webjars/js/rc.all-2.0.js"></script>
    <script src="${homeModule}/webjars/js/RSA.js"></script>
</body>
