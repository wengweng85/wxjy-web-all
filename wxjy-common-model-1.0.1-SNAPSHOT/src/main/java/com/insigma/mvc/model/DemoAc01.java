...
public class DemoAc01 extends PageInfo implements java.io.Serializable {
     ...
     * @NotEmply 检查约束元素是否为NULL或者是EMPTY.
     * <p>
     * Booelan检查
    ...
    @NotNull(groups = {DemoAc01Group.Add.class, DemoAc01Group.Update.class}, message = "姓名不能为空")
    @Length(groups = {DemoAc01Group.Add.class, DemoAc01Group.Update.class}, min = 2, max = 5, message = "姓名长度只能在3-5之间")
    private String aac003;

    @NotNull(groups = {DemoAc01Group.Add.class, DemoAc01Group.Update.class}, message = "身份证号码不能为空")
    private String aac002;

    @NotNull(groups = {DemoAc01Group.Add.class, DemoAc01Group.Update.class}, message = "性别不能为空")
    private String aac004;

    @NotNull(groups = {DemoAc01Group.Add.class, DemoAc01Group.Update.class}, message = "民族不能为空")
    ...
    @NotNull(groups = {DemoAc01Group.Add.class, DemoAc01Group.Update.class}, message = "健康状况不能为空")
    private String aac033;

    @NotNull(groups = {DemoAc01Group.Add.class, DemoAc01Group.Update.class}, message = "婚姻状况不能为空")
    private String aac017;

    @NotNull(groups = {DemoAc01Group.Add.class, DemoAc01Group.Update.class}, message = "政治面貌不能为空")
    private String aac024;

    @NotNull(groups = {DemoAc01Group.Add.class, DemoAc01Group.Update.class}, message = "学历不能为空")
    private String aac011;

    private String[] a_aac011;


    @NotNull(groups = {DemoAc01Group.Add.class, DemoAc01Group.Update.class}, message = "联系电话不能为空")
    private String aae006;

    private String aac067;

    @NotNull(groups = {DemoAc01Group.Add.class, DemoAc01Group.Update.class}, message = "邮箱不能为空")
    @Email(groups = {DemoAc01Group.Add.class, DemoAc01Group.Update.class}, message = "邮件格式错误")
    ...
    private String aac128;

    public String getAac128() {
        return aac128;
    }

    public void setAac128(String aac128) {
        this.aac128 = aac128;
    }
