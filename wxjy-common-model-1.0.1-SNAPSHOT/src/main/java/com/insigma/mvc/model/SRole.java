...
public class SRole extends PageInfo implements java.io.Serializable {
	...
	private String systypecode_name;
	...
	public String getSystypecode_name() {
		return systypecode_name;
	}

	public void setSystypecode_name(String systypecode_name) {
		this.systypecode_name = systypecode_name;
	}
