...
public class XLSXCovertCSVReader {
     ...
     * @param minColumnsThe minimum number of columns to output, or -1 for no minimum
     */
    ...
    public List<String[]> process() throws IOException, OpenXML4JException, ParserConfigurationException, SAXException {
        ...
        while (iter.hasNext()) {
            ...
            if (this.sheetName.equalsIgnoreCase(sheetNameTemp)) {
    ...
    public static void main(String[] args) throws Exception {
        List<String[]> list = XLSXCovertCSVReader.readerExcel( "C:\\Users\\Administrator\\Desktop\\a\\aaaaa.xlsx", "Sheet1",33);
        for (String[] record : list) {
            for (String cell : record) {
            	System.out.println(null==cell?" ":cell);
            }
            System.out.println();
        }
    }
