package com.insigma.common.jpush;
...
public class JpushClientUtil {
    ...
    private final static String jpush_appKey = "b5f52f2280c71af8e89bf708";

    private final static String jpush_masterSecret = "43f2ff624684f95fcd8bd039";

    private static JPushClient jPushClient = new JPushClient(jpush_masterSecret,jpush_appKey);

    private static  Log log=LogFactory.getLog(JpushClientUtil.class);
    ...
    /**
     *  buildPushObject_ios_all_alertWithTitle
     * @param notification_title
     * @param msg_title
     * @param msg_content
     * @param extrasparam
    ...
    public static void main(String[] args){
        /*if(JpushClientUtil.sendToAllAndroid("testAndroid","testAndroid","this is a Android Dev test","")==1){
            log.info("success");
        }*/

        if(JpushClientUtil.sendToAllIos("testAndroid","testAndroid","this is a Android Dev test","")==1){
            log.info("success");
        }
    }
}
