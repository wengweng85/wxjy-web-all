...
public class IPSeeker {  
    //纯真IP数据库名  
    private String IP_FILE="/config/qqway/qqwry.dat";  
    ...
    public IPSeeker()  {  
        ...
        loc = new IPLocation(this);  
        buf = new byte[100];  
        b4 = new byte[4];  
        b3 = new byte[3];  
        try {  
        	String path=java.net.URLDecoder.decode(this.getClass().getResource("/").getPath()+IP_FILE,"utf-8");
        ...
        for(long offset = ipBegin + 4; offset <= endOffset; offset += IP_RECORD_LENGTH) {  
            ...
            if(temp != -1) {  
                ...
                if(ipLoc.getCountry().indexOf(s) != -1 || ipLoc.getArea().indexOf(s) != -1) {  
                    IPEntry entry = new IPEntry(this);  
    ...
    public IPLocation getIPLocation(String ip){  
        IPLocation location=new IPLocation(this);  
